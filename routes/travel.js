...
router.get('/', function (req, res) {
  ...
  if(req.query.dest != undefined && req.query.dest != "")
  {
      ...
      context.route = {arrivalTime:req.query.arrive, destination:destination, origin:"1401 F Street, San Diego, CA 92101 San Diego, East Village, Downtown San Diego San Diego California United States", departureTime:""
                         , dest:req.query.dest, return:req.query.return, ride:req.query.ride, notify:req.query.notify};
